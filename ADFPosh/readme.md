...
6. You'll need to update the linked services for each one with credential password and the storage account key.  You can also use Azure Key Vault instead.  
