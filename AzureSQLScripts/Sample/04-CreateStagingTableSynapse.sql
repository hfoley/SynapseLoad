/*Connect to Synapse DB and run to create schema and staging table on 
Synapse DB 

Text below is to create the schema if needed 

IF NOT EXISTS (SELECT 0
               FROM information_schema.schemata 
               WHERE schema_name='ADF')
BEGIN
  EXEC sp_executesql N'CREATE SCHEMA ADF';
END
GO 
*/

CREATE TABLE [ADF].[ParquetStudent_Stg]
(
	[CRMID] [int] NOT NULL,
